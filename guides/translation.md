...
Thanks for your interest in translating telva! This file has instructions for updating a translation or creating a new translation.
...
Open the language file in `packages/telva/src/translations`
...
In the `packages/telva/src/translations` folder, duplicate the `main.json` file.
...
In the `packages/telva/src/translations/translations.ts` file, import your file and create a new entry in to the `TRANSLATIONS` array like this:
...
export const TRANSLATIONS: TVTranslations = [
  // Default language:
