...
const currentStyleSelector = (s: TVSnapshot) => s.appState.currentStyle
...
const keepOpenSelector = (s: TVSnapshot) => s.settings.keepStyleMenuOpen

const optionsSelector = (s: TVSnapshot) => {
  ...
  switch (activeTool) {
    ...
    case TVShapeType.Text: {
      return 'text'
    }
    case TVShapeType.Rectangle: {
      return 'label'
    }
    ...
    case TVShapeType.Arrow: {
      return 'label'
    }
    case TVShapeType.Line: {
      return 'label'
    }
  }
