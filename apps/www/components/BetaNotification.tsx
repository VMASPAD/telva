...
const STORAGE_KEY = 'telva_dismiss_beta_notification_3'
...
export function BetaNotification() {
  ...
  return (
    <Panel>
      <div>
        On April 4th 2023 at 9:30AM UTC, telva will be offline as we upgrade to our new version.
      </div>
      <div
        style={{
          display: 'flex',
      ...
      >
        ...
        <Link href="https://telva.substack.com/p/telvas-upcoming-re-launch" target="_blank">
