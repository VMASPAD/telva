...
export declare abstract class TLShapeUtil<T extends TLShape, E extends Element = any, M = any> {
  ...
  static Component: <T_1 extends TLShape, E_1 extends Element = any, M_1 = any>(
    component: (
      props: TLComponentProps<T_1, E_1, M_1>,
      ref: TLForwardedRef<E_1>
    ) => React.ReactElement
  ) => React.ForwardRefExoticComponent<
    Pick<TLComponentProps<T_1, E_1, M_1>, string | number | symbol> & React.RefAttributes<unknown>
  >
  static Indicator: <T_1 extends TLShape, M_1 = any>(
    component: (props: {
      shape: T_1
      meta: M_1
      isHovered: boolean
