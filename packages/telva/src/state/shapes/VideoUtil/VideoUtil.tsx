...
import { TVMeta, TVShapeType, TVVideoAsset, VideoShape } from '~types'

type T = VideoShape
type E = HTMLDivElement

export class VideoUtil extends TVShapeUtil<T, E> {
  type = TVShapeType.Video as const
  canBind = true
  canEdit = true
  canClone = true
      ...
      return (
        <HTMLContainer ref={ref} {...events}>
          ...
          >
            ...
            >
              <source src={(asset as TVVideoAsset).src} />
            </VideoElement>
          </Wrapper>
        </HTMLContainer>
      )
