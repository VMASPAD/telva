...
export type TVTranslations = TVTranslation[]

export type TVLanguage = TVTranslations[number]['locale']

export function getTranslation(locale: TVLanguage): TVTranslation {
