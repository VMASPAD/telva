...
import { ColorStyle, DashStyle, SessionType, SizeStyle, TVShapeType } from '~types'

let app: TelvaTestApp

beforeEach(() => {
  app = new TelvaTestApp()
...
describe('insert command', () => {
  ...
  it('Centers inserted content at a point', () => {
    ...
    expect(
      Utils.getBoundsCenter(Utils.getCommonBounds(inserted.map(TVDR.getBounds)))
    ).toMatchObject(point)
  })
