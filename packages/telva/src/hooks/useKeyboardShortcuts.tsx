...
import { useFileSystemHandlers, useTelvaApp } from '~hooks'
import { AlignStyle, TVExportType, TVShapeType } from '~types'
...
export function useKeyboardShortcuts(ref: React.RefObject<HTMLDivElement>) {
  ...
  useHotkeys(
    ...
    () => {
      if (!canHandleEvent(true)) return
      app.selectTool(TVShapeType.Pen)
    },
    undefined,
    [app]
  )
  ...
  useHotkeys(
    ...
    () => {
      if (!canHandleEvent(true)) return
      app.selectTool(TVShapeType.Ellipse)
    },
    undefined,
    [app]
  )
  ...
  useHotkeys(
    ...
    () => {
      ...
      app.selectTool(TVShapeType.Triangle)
    },
    undefined,
    [app]
  )
  ...
  useHotkeys(
    ...
    () => {
      if (!canHandleEvent(true)) return
      app.selectTool(TVShapeType.Line)
    },
    undefined,
    [app]
  )
  ...
  useHotkeys(
    ...
    () => {
      if (!canHandleEvent(true)) return
      app.selectTool(TVShapeType.Arrow)
    },
    undefined,
    [app]
  )
  ...
  useHotkeys(
    ...
    () => {
      if (!canHandleEvent(true)) return
      app.selectTool(TVShapeType.Text)
    },
    undefined,
    [app]
  )
  ...
  useHotkeys(
    ...
    () => {
      if (!canHandleEvent(true)) return
      app.selectTool(TVShapeType.Sticky)
    },
    undefined,
    [app]
  )
  ...
  useHotkeys(
    ...
    (e) => {
      ...
      app.exportImage(TVExportType.SVG, { scale: 2, quality: 1 })
    },
    undefined,
    [app]
  )
