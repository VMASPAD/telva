...
const edgeClassnames = {
  [TLBoundsEdge.Top]: 'tv-cursor-ns',
  [TLBoundsEdge.Right]: 'tv-cursor-ew',
  [TLBoundsEdge.Bottom]: 'tv-cursor-ns',
  [TLBoundsEdge.Left]: 'tv-cursor-ew',
}
...
function _EdgeHandle({ size, isHidden, bounds, edge }: EdgeHandleProps) {
  ...
  return (
    <rect
      ...
      className={'tv-transparent tv-edge-handle ' + (isHidden ? '' : edgeClassnames[edge])}
