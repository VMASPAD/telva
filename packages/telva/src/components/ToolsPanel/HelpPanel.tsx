...
const isDebugModeSelector = (s: TVSnapshot) => s.settings.isDebugMode
...
const linksData = [
  { id: 'telva-beta', icon: ExternalLinkIcon, url: 'https://beta.telva.com' },
  { id: 'github', icon: GitHubLogoIcon, url: 'https://github.com/telva/telva' },
  { id: 'twitter', icon: TwitterLogoIcon, url: 'https://twitter.com/telva' },
