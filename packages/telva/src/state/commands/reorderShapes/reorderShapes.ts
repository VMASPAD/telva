...
import { MoveType, TVShape, TelvaCommand } from '~types'

export function reorderShapes(app: TelvaApp, ids: string[], type: MoveType): TelvaCommand {
  ...
  let result: {
    before: Record<string, Partial<TVShape>>
    after: Record<string, Partial<TVShape>>
  } = { before: {}, after: {} }
