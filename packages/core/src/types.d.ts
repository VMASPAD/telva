...
export declare type TLForwardedRef<T> =
...
export declare type TLUsers = Record<string, TLUser>
...
export declare type TLShapeChangeHandler<T extends TLShape, K = any> = (
  shape: {
    id: string
  } & Partial<T>,
  info?: K
...
export declare type TLKeyboardEventHandler = (
  key: string,
  info: TLKeyboardInfo,
  e: KeyboardEvent
) => void
...
export declare type TLShapeCloneHandler = (
  info: TLPointerInfo<
    'top' | 'right' | 'bottom' | 'left' | 'topLeft' | 'topRight' | 'bottomLeft' | 'bottomRight'
  >,
  e: React.PointerEvent
) => void
export declare type TLShapeLinkHandler = (
  info: TLPointerInfo<'link'>,
  e: React.PointerEvent
) => void
...
export declare type TLBoundsHandle =
  | TLBoundsCorner
  | TLBoundsEdge
  | 'rotate'
  | 'center'
