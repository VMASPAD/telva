...
import { DistributeType, TVShape, TVShapeType, TelvaCommand } from '~types'

export function distributeShapes(app: TelvaApp, ids: string[], type: DistributeType): TelvaCommand {
...
function getDistributions(initialShapes: TVShape[], type: DistributeType) {
