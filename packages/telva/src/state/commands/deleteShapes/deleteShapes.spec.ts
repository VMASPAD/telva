...
describe('Delete command', () => {
  ...
  describe('when deleting shapes with assets', () => {
    it('should remove the asset from the asset table', () => {
      const app = new TelvaTestApp().loadDocument(mockDocumentWithImage)
    ...
    it('should not remove a shared asset from the asset table', () => {
      const app = new TelvaTestApp().loadDocument(mockDocumentWithSharedAssets).delete(['image1'])
...
const mockDocumentWithImage: TVDocument = {
  version: 16,
  id: 'doc',
  name: 'New Document',
  pages: {
...
const mockDocumentWithSharedAssets: TVDocument = {
  version: 16,
  id: 'doc',
  name: 'New Document',
  pages: {
