...
import { DistributeType, TVShapeType } from '~types'
...
describe('when distributing groups', () => {
  it('distributes children', () => {
    const app = new TelvaTestApp()
      .createShapes(
        { id: 'rect1', type: TVShapeType.Rectangle, point: [0, 0], size: [100, 100] },
        { id: 'rect2', type: TVShapeType.Rectangle, point: [100, 100], size: [100, 100] },
        { id: 'rect3', type: TVShapeType.Rectangle, point: [200, 200], size: [100, 100] },
        { id: 'rect4', type: TVShapeType.Rectangle, point: [0, 0], size: [200, 200] },
        { id: 'rect5', type: TVShapeType.Rectangle, point: [300, -200], size: [100, 100] }
      )
