import { TLBoundsCorner, TLBoundsEdge, TLBoundsHandle, inputs } from 'telva-core'
import { TelvaApp } from '~state'
import type { TVShape } from '~types'
...
export class TelvaTestApp extends TelvaApp {
  ...
  expectShapesToHaveProps = <T extends TVShape>(shapes: Record<string, Partial<T>>) => {
